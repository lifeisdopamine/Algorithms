/**
 * @file Programming Assignment 4 Question 3
 * @Author: Yash Shah
 * @brief: Program to segregate odd and even numbers from two stacks and store them in one stack in alternate order.
 * @date: 10/16/2017
 */
